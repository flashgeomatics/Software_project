...
bash_command('bokeh serve ./stat.py --allow-websocket-origin=127.0.0.1:5000')
...
def register():
    ...
    if form.validate_on_submit():
            ...
            cur.close()
            conn.commit()
            flash(f'Congratulations {form.username.data} for your registration!', 'success')
...
def statistics():
    script=server_document("http://localhost:5006/stat")
    print(script)
